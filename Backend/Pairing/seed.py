...
from model import Recipe, RecipeIngredient, Ingredient, FlavorCompound, Category, \
    FlavorCompoundIngredient, Cuisine, Region, IngredientSimilarity, IngredientSimCuisine, connect_to_db, db
